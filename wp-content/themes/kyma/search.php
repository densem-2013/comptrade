                ...
                <div class="content_block col-md-9 <?php echo esc_attr($float); ?> ">
                    ...
                    if (have_posts()) {
                        ...
                        <?php while (have_posts()) {
                            ...
                            <div class="hm_blog_list clearfix">
                                    ...
                                    <div class="feature_inner">
                                        <div class="feature_inner_corners">
                                            <div class="feature_inner_btns">
                                                ...
                                                <a href="#" class="icon_link"><i class="fa fa-link3"></i></a>
                                            </div>
                                            <?php $icon = '';
                                            global $imageSize;
                                            if (get_post_gallery()) {
								...
								<span
                                    class="meta"><?php
                                    if (isset($icon) && $icon == 'fa fa-image') {
                                        ?>
                                    ...
                                    <span class="meta_part">
										<a href="#">
                                            ...
                                            <span><?php echo esc_attr(get_the_date('F j, Y')); ?></span>
                                        </a>
									</span><?php
                    ...
                    <?php } else { ?>
                        <div class="search_error">
                            <div class="search_err_heading"><h2><?php _e("Nothing Found", 'kyma'); ?></h2></div>
