	...
	<div class="smart-wrap">
    	<div class="smart-forms smart-container wrap-1">
        	...
        	<div class="form-header header-primary">
            	<h4><i class="fa fa-list-ul"></i><?php _e('Apply Setting On Gallery','SMGL_TEXT_DOMAIN')?></h4>
            ...
            <form method="post" action="" id="form-ui">
            	<div class="form-body">
					...
					<div class="frm-row"><!-- Custom CSS -->
                    	<label class="field-label colm colm4 align-left"><?php _e('Custom CSS','SMGL_TEXT_DOMAIN'); ?>:</label>
                        <div class="section colm colm8">
							<label class="field prepend-icon">
								...
								<span class="input-hint">
									<strong<?php _e('Note','SMGL_TEXT_DOMAIN'); ?>>:</strong> <?php _e('Please Do Not Use','SMGL_TEXT_DOMAIN'); ?> <b>Style</b> Tag <?php _e('With Custom CSS','SMGL_TEXT_DOMAIN'); ?>.
								</span>
							</label>
						</div>
